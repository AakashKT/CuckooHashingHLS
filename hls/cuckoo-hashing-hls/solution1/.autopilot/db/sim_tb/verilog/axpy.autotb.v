...
`define AUTOTB_DUT      axpy
`define AUTOTB_DUT_INST AESL_inst_axpy
`define AUTOTB_TOP      apatb_axpy_top
`define AUTOTB_LAT_RESULT_FILE "axpy.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "axpy.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_axpy_top
...
`define AUTOTB_TVIN_in_r  "./c.axpy.autotvin_in_r.dat"
`define AUTOTB_TVIN_a  "./c.axpy.autotvin_a.dat"
`define AUTOTB_TVIN_b  "./c.axpy.autotvin_b.dat"
`define AUTOTB_TVIN_out_r  "./c.axpy.autotvin_out_r.dat"
`define AUTOTB_TVIN_in_r_out_wrapc  "./rtl.axpy.autotvin_in_r.dat"
`define AUTOTB_TVIN_a_out_wrapc  "./rtl.axpy.autotvin_a.dat"
`define AUTOTB_TVIN_b_out_wrapc  "./rtl.axpy.autotvin_b.dat"
`define AUTOTB_TVIN_out_r_out_wrapc  "./rtl.axpy.autotvin_out_r.dat"
`define AUTOTB_TVOUT_out_r  "./c.axpy.autotvout_out_r.dat"
`define AUTOTB_TVOUT_out_r_out_wrapc  "./impl_rtl.axpy.autotvout_out_r.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.axpy.autotvout_out_r.dat", "r");
    fp2 = $fopen("./impl_rtl.axpy.autotvout_out_r.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.axpy.autotvout_out_r.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.axpy.autotvout_out_r.dat\"!");
    else begin
        $display("Comparing rtl.axpy.autotvout_out_r.dat with impl_rtl.axpy.autotvout_out_r.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
