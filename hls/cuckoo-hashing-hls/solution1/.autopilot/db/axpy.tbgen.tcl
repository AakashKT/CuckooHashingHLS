set C_TypeInfoList {{ 
"axpy" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"in": [[], {"array": [ {"scalar": "int"}, [3]]}] }, {"a": [[], {"scalar": "int"}] }, {"b": [[], {"scalar": "int"}] }, {"out": [[], {"array": [ {"scalar": "int"}, [3]]}] }],[],""]
}}
set moduleName axpy
...
set portList { 
	...
	{ out_r_address0 sc_out sc_lv 2 signal 3 } 
