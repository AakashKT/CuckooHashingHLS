...
@.str3 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1 ; [#uses=26 type=[1 x i8]*]
...
define void @traffic_generate_and_execute([200 x i64]* %rrps) nounwind uwtable {
  call void (...)* @_ssdm_op_SpecBitsMap([200 x i64]* %rrps) nounwind, !map !2818
  call void (...)* @_ssdm_op_SpecTopModule([29 x i8]* @traffic_generate_and_execute.str) nounwind
  %key_to_metadata.key = alloca [3 x [128 x i32]], align 4 ; [#uses=2 type=[3 x [128 x i32]]*]
  %key_to_metadata.occupied = alloca [3 x [128 x i1]], align 1 ; [#uses=3 type=[3 x [128 x i1]]*]
  call void @llvm.dbg.value(metadata !{[200 x i64]* %rrps}, i64 0, metadata !2824), !dbg !2828 ; [debug line = 259:44] [debug variable = rrps]
  call void (...)* @_ssdm_op_SpecInterface([200 x i64]* %rrps, [5 x i8]* @.str13, i32 0, i32 0, [1 x i8]* @.str3, i32 0, i32 0, [1 x i8]* @.str3, [1 x i8]* @.str3, [1 x i8]* @.str3, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str3, [1 x i8]* @.str3) nounwind
  call void @llvm.dbg.declare(metadata !{[3 x [128 x i1]]* %key_to_metadata.occupied}, metadata !2829), !dbg !2837 ; [debug line = 263:12] [debug variable = key_to_metadata.occupied]
  br label %arrayctor.loop

arrayctor.loop:                                   ; preds = %arrayctor.loop1, %0
  %tmp = phi i2 [ 0, %0 ], [ %tmp.1, %arrayctor.loop1 ] ; [#uses=3 type=i2]
  %tmp.1 = add i2 %tmp, 1, !dbg !2838             ; [#uses=1 type=i2] [debug line = 263:61]
  %tmp.2 = zext i2 %tmp to i64, !dbg !2838        ; [#uses=1 type=i64] [debug line = 263:61]
...
arrayctor.loop3:                                  ; preds = %arrayctor.loop3, %arrayctor.loop
  %tmp.3 = phi i7 [ 0, %arrayctor.loop ], [ %tmp.4, %arrayctor.loop3 ] ; [#uses=3 type=i7]
  %tmp.4 = add i7 %tmp.3, 1, !dbg !2838           ; [#uses=1 type=i7] [debug line = 263:61]
  %tmp.5 = zext i7 %tmp.3 to i64, !dbg !2838      ; [#uses=1 type=i64] [debug line = 263:61]
  %key_to_metadata.occupied.addr = getelementptr [3 x [128 x i1]]* %key_to_metadata.occupied, i64 0, i64 %tmp.2, i64 %tmp.5, !dbg !2839 ; [#uses=1 type=i1*] [debug line = 43:42@263:61]
  store i1 false, i1* %key_to_metadata.occupied.addr, align 4, !dbg !2839 ; [debug line = 43:42@263:61]
  %tmp.6 = icmp eq i7 %tmp.3, -1, !dbg !2838      ; [#uses=1 type=i1] [debug line = 263:61]
  %2 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 128, i64 128, i64 128) nounwind ; [#uses=0 type=i32]
  br i1 %tmp.6, label %arrayctor.loop1, label %arrayctor.loop3, !dbg !2838 ; [debug line = 263:61]

; <label>:3                                       ; preds = %arrayctor.loop1
  call void (...)* @_ssdm_op_SpecMemCore([3 x [128 x i32]]* %key_to_metadata.key, [3 x [128 x i1]]* %key_to_metadata.occupied, [1 x i8]* @.str3, [12 x i8]* @.str4, [1 x i8]* @.str3, i32 -1, [1 x i8]* @.str3, [1 x i8]* @.str3, [1 x i8]* @.str3, [1 x i8]* @.str3, [1 x i8]* @.str3) nounwind
  br label %4, !dbg !2840                         ; [debug line = 273:15]

; <label>:4                                       ; preds = %.preheader.preheader, %3
  %writeix = phi i8 [ 0, %3 ], [ %writeix.1, %.preheader.preheader ] ; [#uses=3 type=i8]
  %i = phi i7 [ 0, %3 ], [ %i.1, %.preheader.preheader ] ; [#uses=2 type=i7]
  %exitcond1 = icmp eq i7 %i, -28, !dbg !2840     ; [#uses=1 type=i1] [debug line = 273:15]
  %5 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 100, i64 100, i64 100) nounwind ; [#uses=0 type=i32]
  br i1 %exitcond1, label %6, label %.preheader.preheader, !dbg !2840 ; [debug line = 273:15]

arrayctor.loop1:                                  ; preds = %arrayctor.loop3
  %tmp.7 = icmp eq i2 %tmp, -2, !dbg !2838        ; [#uses=1 type=i1] [debug line = 263:61]
  br i1 %tmp.7, label %3, label %arrayctor.loop, !dbg !2838 ; [debug line = 263:61]

.preheader.preheader:                             ; preds = %4
  %call.ret = call fastcc i1 @execute([3 x [128 x i32]]* %key_to_metadata.key, [3 x [128 x i1]]* %key_to_metadata.occupied) nounwind, !dbg !2842 ; [#uses=1 type=i1] [debug line = 280:18]
  %tmp.9 = or i8 %writeix, 1, !dbg !2844          ; [#uses=1 type=i8] [debug line = 283:21]
  %tmp. = zext i8 %writeix to i64, !dbg !2844     ; [#uses=1 type=i64] [debug line = 283:21]
  %rrps.addr = getelementptr [200 x i64]* %rrps, i64 0, i64 %tmp., !dbg !2844 ; [#uses=1 type=i64*] [debug line = 283:21]
  store i64 17179869185, i64* %rrps.addr, align 8, !dbg !2844 ; [debug line = 283:21]
  %tmp.i = call i43 @_ssdm_op_BitConcatenate.i43.i40.i1.i2(i40 4294967296, i1 %call.ret, i2 0) ; [#uses=1 type=i43]
  %packed = zext i43 %tmp.i to i64, !dbg !2845    ; [#uses=1 type=i64] [debug line = 106:2@284:21]
  call void @llvm.dbg.value(metadata !{i64 %packed}, i64 0, metadata !2848) nounwind, !dbg !2845 ; [debug line = 106:2@284:21] [debug variable = packed]
  %writeix.1 = add i8 %writeix, 2, !dbg !2847     ; [#uses=1 type=i8] [debug line = 284:21]
  call void @llvm.dbg.value(metadata !{i8 %writeix.1}, i64 0, metadata !2849), !dbg !2847 ; [debug line = 284:21] [debug variable = writeix]
  %tmp.8 = zext i8 %tmp.9 to i64, !dbg !2847      ; [#uses=1 type=i64] [debug line = 284:21]
  %rrps.addr.1 = getelementptr [200 x i64]* %rrps, i64 0, i64 %tmp.8, !dbg !2847 ; [#uses=1 type=i64*] [debug line = 284:21]
  store i64 %packed, i64* %rrps.addr.1, align 8, !dbg !2847 ; [debug line = 284:21]
  %i.1 = add i7 %i, 1, !dbg !2850                 ; [#uses=1 type=i7] [debug line = 273:40]
  call void @llvm.dbg.value(metadata !{i7 %i.1}, i64 0, metadata !2851), !dbg !2850 ; [debug line = 273:40] [debug variable = i]
  br label %4, !dbg !2850                         ; [debug line = 273:40]

; <label>:6                                       ; preds = %4
  ret void, !dbg !2852                            ; [debug line = 286:1]
}
...
; [#uses=1]
define internal fastcc i1 @execute([3 x [128 x i32]]* %key_to_metadata.key, [3 x [128 x i1]]* %key_to_metadata.occupied) {
  call void @llvm.dbg.value(metadata !{[3 x [128 x i32]]* %key_to_metadata.key}, i64 0, metadata !2853), !dbg !2858 ; [debug line = 136:13] [debug variable = key_to_metadata.key]
  call void @llvm.dbg.value(metadata !{[3 x [128 x i1]]* %key_to_metadata.occupied}, i64 0, metadata !2859), !dbg !2858 ; [debug line = 136:13] [debug variable = key_to_metadata.occupied]
  call void (...)* @_ssdm_op_SpecMemCore([3 x [128 x i32]]* %key_to_metadata.key, [3 x [128 x i1]]* %key_to_metadata.occupied, [1 x i8]* @.str3, [12 x i8]* @.str4, [1 x i8]* @.str3, i32 -1, [1 x i8]* @.str3, [1 x i8]* @.str3, [1 x i8]* @.str3, [1 x i8]* @.str3, [1 x i8]* @.str3)
  call void (...)* @_ssdm_op_SpecInterface([3 x [128 x i32]]* %key_to_metadata.key, [3 x [128 x i1]]* %key_to_metadata.occupied, [10 x i8]* @.str5, i32 0, i32 0, [1 x i8]* @.str3, i32 0, i32 0, [1 x i8]* @.str3, [1 x i8]* @.str3, [1 x i8]* @.str3, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str3, [1 x i8]* @.str3) nounwind
  call void (...)* @_ssdm_SpecKeepAssert(i32 1)
  call void (...)* @_ssdm_SpecKeepAssert(i32 6)
  %key_to_metadata.occupied.addr = getelementptr [3 x [128 x i1]]* %key_to_metadata.occupied, i64 0, i64 1, i64 6, !dbg !2860 ; [#uses=2 type=i1*] [debug line = 208:3]
  %key_to_metadata.occupied.load = load i1* %key_to_metadata.occupied.addr, align 1, !dbg !2860 ; [#uses=1 type=i1] [debug line = 208:3]
  br i1 %key_to_metadata.occupied.load, label %1, label %._crit_edge1, !dbg !2860 ; [debug line = 208:3]

; <label>:1                                       ; preds = %0
  %key_to_metadata.key.addr = getelementptr [3 x [128 x i32]]* %key_to_metadata.key, i64 0, i64 1, i64 6, !dbg !2860 ; [#uses=1 type=i32*] [debug line = 208:3]
  %key_to_metadata.key.load = load i32* %key_to_metadata.key.addr, align 4, !dbg !2860 ; [#uses=1 type=i32] [debug line = 208:3]
  %tmp.9 = icmp eq i32 %key_to_metadata.key.load, 4, !dbg !2860 ; [#uses=1 type=i1] [debug line = 208:3]
  br i1 %tmp.9, label %2, label %._crit_edge1, !dbg !2860 ; [debug line = 208:3]

._crit_edge1:                                     ; preds = %1, %0
  br label %._crit_edge, !dbg !2863               ; [debug line = 211:4]

; <label>:2                                       ; preds = %1
  store i1 false, i1* %key_to_metadata.occupied.addr, align 1, !dbg !2865 ; [debug line = 218:3]
  br label %._crit_edge, !dbg !2866               ; [debug line = 220:3]

._crit_edge:                                      ; preds = %2, %._crit_edge1
  %agg.result.delete_element_not_found.write.assign = phi i1 [ false, %2 ], [ true, %._crit_edge1 ] ; [#uses=1 type=i1]
  call void @llvm.dbg.value(metadata !{i1 %agg.result.delete_element_not_found.write.assign}, i64 0, metadata !2867) ; [debug variable = agg.result.delete_element_not_found]
  ret i1 %agg.result.delete_element_not_found.write.assign
}
...
; [#uses=0]
declare i43 @_ssdm_op_BitConcatenate.i43.i8.i32.i1.i1.i1(i8, i32, i1, i1, i1) nounwind readnone

; [#uses=1]
declare i43 @_ssdm_op_BitConcatenate.i43.i40.i1.i2(i40, i1, i2) nounwind readnone
...
!901 = metadata !{i32 786478, i32 0, metadata !902, metadata !"terrible_hash_fn", metadata !"terrible_hash_fn", metadata !"_Z16terrible_hash_fnii", metadata !902, i32 10, metadata !903, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !12, i32 10} ; [ DW_TAG_subprogram ]
...
!906 = metadata !{i32 786478, i32 0, metadata !902, metadata !"hash_picker_fn", metadata !"hash_picker_fn", metadata !"_Z14hash_picker_fni", metadata !902, i32 14, metadata !907, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !12, i32 14} ; [ DW_TAG_subprogram ]
...
!961 = metadata !{i32 786478, i32 0, metadata !902, metadata !"create_random_request", metadata !"create_random_request", metadata !"_Z21create_random_requestPj", metadata !902, i32 54, metadata !962, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !12, i32 54} ; [ DW_TAG_subprogram ]
...
!965 = metadata !{i32 786478, i32 0, metadata !902, metadata !"request_pack", metadata !"request_pack", metadata !"_Z12request_pack7Request", metadata !902, i32 89, metadata !966, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !12, i32 89} ; [ DW_TAG_subprogram ]
...
!972 = metadata !{i32 786478, i32 0, metadata !902, metadata !"response_pack", metadata !"response_pack", metadata !"_Z13response_pack8Response", metadata !902, i32 100, metadata !973, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !12, i32 100} ; [ DW_TAG_subprogram ]
...
!978 = metadata !{i32 786478, i32 0, metadata !902, metadata !"execute", metadata !"execute", metadata !"_Z7execute7RequestPA128_9KMetadataPA128_2KV", metadata !902, i32 134, metadata !979, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !12, i32 138} ; [ DW_TAG_subprogram ]
...
!998 = metadata !{i32 786478, i32 0, metadata !902, metadata !"traffic_generate_and_execute", metadata !"traffic_generate_and_execute", metadata !"_Z28traffic_generate_and_executePm", metadata !902, i32 259, metadata !999, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !12, i32 259} ; [ DW_TAG_subprogram ]
...
!2761 = metadata !{null, metadata !2762, metadata !2756, metadata !2763, metadata !2758, metadata !2764, metadata !2760}
...
!2765 = metadata !{null, metadata !2766, metadata !2767, metadata !2768, metadata !2769, metadata !2770, metadata !2760}
...
!2783 = metadata !{null, metadata !2784, metadata !2767, metadata !2785, metadata !2769, metadata !2786, metadata !2760}
...
!2787 = metadata !{null, metadata !2766, metadata !2767, metadata !2788, metadata !2769, metadata !2789, metadata !2760}
...
!2793 = metadata !{null, metadata !2766, metadata !2767, metadata !2794, metadata !2769, metadata !2789, metadata !2760}
!2794 = metadata !{metadata !"kernel_arg_type", metadata !"struct Response"}
!2795 = metadata !{null, metadata !2796, metadata !2797, metadata !2798, metadata !2799, metadata !2800, metadata !2760}
...
!2804 = metadata !{null, metadata !2784, metadata !2767, metadata !2805, metadata !2769, metadata !2806, metadata !2760}
...
!2811 = metadata !{metadata !2812, [1 x i32]* @llvm.global_ctors.0}
!2812 = metadata !{metadata !2813}
!2813 = metadata !{i32 0, i32 31, metadata !2814}
!2814 = metadata !{metadata !2815}
!2815 = metadata !{metadata !"llvm.global_ctors.0", metadata !2816, metadata !"", i32 0, i32 31}
!2816 = metadata !{metadata !2817}
!2817 = metadata !{i32 0, i32 0, i32 1}
!2818 = metadata !{metadata !2819}
!2819 = metadata !{i32 0, i32 63, metadata !2820}
!2820 = metadata !{metadata !2821}
!2821 = metadata !{metadata !"rrps", metadata !2822, metadata !"long unsigned int", i32 0, i32 63}
!2822 = metadata !{metadata !2823}
!2823 = metadata !{i32 0, i32 199, i32 1}
!2824 = metadata !{i32 786689, metadata !998, metadata !"rrps", null, i32 259, metadata !2825, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2825 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 0, i64 0, i32 0, i32 0, metadata !968, metadata !2826, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2826 = metadata !{metadata !2827}
!2827 = metadata !{i32 786465, i64 0, i64 199}    ; [ DW_TAG_subrange_type ]
!2828 = metadata !{i32 259, i32 44, metadata !998, null}
!2829 = metadata !{i32 790529, metadata !2830, metadata !"key_to_metadata.occupied", null, i32 263, metadata !2834, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2830 = metadata !{i32 786688, metadata !2831, metadata !"key_to_metadata", metadata !902, i32 263, metadata !2832, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2831 = metadata !{i32 786443, metadata !998, i32 259, i32 87, metadata !902, i32 21} ; [ DW_TAG_lexical_block ]
!2832 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 24576, i64 32, i32 0, i32 0, metadata !944, metadata !2833, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2833 = metadata !{metadata !1093, metadata !984}
!2834 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 3072, i64 32, i32 0, i32 0, metadata !2835, metadata !2833, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2835 = metadata !{i32 786438, null, metadata !"KMetadata", metadata !913, i32 18, i64 8, i64 32, i32 0, i32 0, null, metadata !2836, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!2836 = metadata !{metadata !947}
!2837 = metadata !{i32 263, i32 12, metadata !2831, null}
!2838 = metadata !{i32 263, i32 61, metadata !2831, null}
!2839 = metadata !{i32 43, i32 42, metadata !940, metadata !2838}
!2840 = metadata !{i32 273, i32 15, metadata !2841, null}
!2841 = metadata !{i32 786443, metadata !2831, i32 273, i32 2, metadata !902, i32 22} ; [ DW_TAG_lexical_block ]
!2842 = metadata !{i32 280, i32 18, metadata !2843, null}
!2843 = metadata !{i32 786443, metadata !2841, i32 273, i32 45, metadata !902, i32 23} ; [ DW_TAG_lexical_block ]
!2844 = metadata !{i32 283, i32 21, metadata !2843, null}
!2845 = metadata !{i32 106, i32 2, metadata !2846, metadata !2847}
!2846 = metadata !{i32 786443, metadata !972, i32 100, i32 36, metadata !902, i32 11} ; [ DW_TAG_lexical_block ]
!2847 = metadata !{i32 284, i32 21, metadata !2843, null}
!2848 = metadata !{i32 786688, metadata !2846, metadata !"packed", metadata !902, i32 101, metadata !968, i32 0, metadata !2847} ; [ DW_TAG_auto_variable ]
!2849 = metadata !{i32 786688, metadata !2831, metadata !"writeix", metadata !902, i32 270, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2850 = metadata !{i32 273, i32 40, metadata !2841, null}
!2851 = metadata !{i32 786688, metadata !2841, metadata !"i", metadata !902, i32 273, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2852 = metadata !{i32 286, i32 1, metadata !2831, null}
!2853 = metadata !{i32 790531, metadata !2854, metadata !"key_to_metadata.key", null, i32 136, metadata !2855, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2854 = metadata !{i32 786689, metadata !978, metadata !"key_to_metadata", metadata !902, i32 33554568, metadata !981, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2855 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 12288, i64 32, i32 0, i32 0, metadata !2856, metadata !2833, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2856 = metadata !{i32 786438, null, metadata !"KMetadata", metadata !913, i32 18, i64 32, i64 32, i32 0, i32 0, null, metadata !2857, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!2857 = metadata !{metadata !946}
!2858 = metadata !{i32 136, i32 13, metadata !978, null}
!2859 = metadata !{i32 790531, metadata !2854, metadata !"key_to_metadata.occupied", null, i32 136, metadata !2834, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2860 = metadata !{i32 208, i32 3, metadata !2861, null}
!2861 = metadata !{i32 786443, metadata !2862, i32 176, i32 19, metadata !902, i32 14} ; [ DW_TAG_lexical_block ]
!2862 = metadata !{i32 786443, metadata !978, i32 138, i32 52, metadata !902, i32 13} ; [ DW_TAG_lexical_block ]
!2863 = metadata !{i32 211, i32 4, metadata !2864, null}
!2864 = metadata !{i32 786443, metadata !2861, i32 209, i32 52, metadata !902, i32 17} ; [ DW_TAG_lexical_block ]
!2865 = metadata !{i32 218, i32 3, metadata !2861, null}
!2866 = metadata !{i32 220, i32 3, metadata !2861, null}
!2867 = metadata !{i32 790535, metadata !2868, metadata !"agg.result.delete_element_not_found", null, i32 134, metadata !2870, i32 0, i32 0} ; [ DW_TAG_arg_variable_field_wo ]
!2868 = metadata !{i32 786690, metadata !978, metadata !"agg.result", metadata !902, i32 134, metadata !2869, i32 0, i32 0} ; [ DW_TAG_return_variable ]
!2869 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !953} ; [ DW_TAG_pointer_type ]
!2870 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !2871} ; [ DW_TAG_pointer_type ]
!2871 = metadata !{i32 786438, null, metadata !"Response", metadata !913, i32 85, i64 8, i64 32, i32 0, i32 0, null, metadata !2872, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!2872 = metadata !{metadata !957}
